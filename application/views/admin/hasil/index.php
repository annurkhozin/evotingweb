	...
	<div class="row-fluid">
		<div class="box span12">
			<div class="box-header blue" data-original-title>
				<h2><i class="icon-screenshot"></i><span class="break"></span>Jurusan Pemilih Aktif</h2>
			</div>
			</br>
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center" >
									<center>
										<center>
										<a href="<?php echo site_url('hasil/tahun/'.$row->id_campaign);?>" class="btn btn-md  btn-default tooltipsku" title="Detail <?php echo $row->nama_campaign;?>"><i class="halflings-icon search white"></i> Lihat</a>
										</center>
									</center>
								</td>
							</tr>
