...
<div class="modal hide fade " id="nonaktifkanmaha<?php echo $row->nim;?>">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">×</button>
		<h3>Nonaktifkan Data <?php echo $langit;?></h3>
	</div>
	<div class="modal-body">
		<form id="frm" name="frm" class="form-horizontal" action="<?php echo site_url(enkripsi('mahasiswa','nonaktifkan'));?>" method="post">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" readonly value="<?php echo $row->nim;?>" name="id[]" class="span10">
				</div>
			</div>
			<div class="control-group">
				<label class="span1"></label><label class="span3">Nama</label>
				<div class="controls">
					<input type="text" readonly value="<?php echo $row->nama_mahas;?>" class="span10">
				</div>
			</div>		
			<div class="control-group">
