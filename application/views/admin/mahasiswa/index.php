...
<div id="content" class="span10">
	...
	<a href="<?php echo site_url(enkripsi('mahasiswa','nonaktif'));?>" class="btn btn-danger"><i class="halflings-icon trash white"></i> Ke <?php echo $langit; ?> Nonaktif</a>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			<form id="frm" name="frm" class="form-horizontal" action="<?php echo site_url(enkripsi('mahasiswa','nonaktifkan'));?>" method="post">
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					<button type="submit" class="btn btn-md btn-danger" onclick="return confirm('Hati-Hati dengan Tindakan Anda! Mahasiswa yang dipilih akan di Non-Aktifkan !'); ">
					<i class="halflings-icon trash white"></i> Mahasiswa</button></br></br>
					<thead>
						<tr>
							<th><center><input type="checkbox" id="checkall" name="checkall"></center></th>
							<th>NIM <?php echo $katalangit; ?></th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="center" >
								<center>
									<a class="btn btn-md btn-default tooltipsku" href="#detail<?php echo $baris->nim;?>" data-toggle="modal"
										title="<?php echo 'Detail Data '.$baris->nama_mahas;?>">
										<i class="halflings-icon white search"></i>  
									</a>
									<a class="btn btn-md btn-info tooltipsku" href="#edit<?php echo $baris->nim;?>" data-toggle="modal"
										title="<?php echo 'Edit Data '.$baris->nama_mahas;?>">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-md btn-danger tooltipsku" href="#nonaktifkanmaha<?php echo $baris->nim;?>" data-toggle="modal"
									title="<?php echo 'Nonaktifkan Data '.$baris->nama_mahas;?>">
...
<?php 
	$this->load->view('admin/mahasiswa/tambah.php');
	$this->load->view('admin/mahasiswa/detail.php');
	$this->load->view('admin/mahasiswa/edit.php');
	$this->load->view('admin/mahasiswa/butcetak.php');
	$this->load->view('admin/mahasiswa/nonaktifkan.php');
?>
<script>
