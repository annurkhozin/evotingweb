<!--baris ini adalah modal untuk edit dosen-->
<?php $no=0; foreach($dosen as $row): $no++?>
<div class="modal hide fade " id="edit<?php echo $row->id_dos;?>">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">×</button>
		<h3>Edit <?php echo $langit;?></h3>
	</div>
	<div class="modal-body">
		<form id="frm" name="frm" class="form-horizontal" action="<?php echo site_url('dosen/edit');?>" method="post" enctype="multipart/form-data">
			<div class="control-group">
				<label class="span1"></label><label class="span3">ID Dosen</label>
				<div class="controls">
					<input type="text" name="id" readonly value="<?php echo $row->id_dos;?>" data-validation-required-message="Harus Diisi" placeholder="NIM Dosen" class="span10" required autocomplete='off'>
				</div>
			</div>
			<div class="control-group">
				<label class="span1"></label><label class="span3">Nama Dosen</label>
				<div class="controls">
					<input type="text" name="nama" value="<?php echo $row->nama_dos;?>" data-validation-required-message="Harus Diisi" placeholder="Nama Dosen" class="span10" required autocomplete='off'>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="almat" value="<?php echo $row->alamat;?>"placeholder="Alamat Dosen" class="span10">
				</div>
			</div>
			<div class="control-group">
