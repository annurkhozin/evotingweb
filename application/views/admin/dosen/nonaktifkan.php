...
<div class="modal hide fade " id="nonaktifkandos<?php echo $row->id_dos;?>">
	...
	<div class="modal-body">
		<form id="frm" name="frm" class="form-horizontal" action="<?php echo site_url(enkripsi('dosen','nonaktifkan'));?>" method="post">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" readonly name="id[]" readonly value="<?php echo $row->id_dos;?>" class="span10">
				</div>
			</div>
			<div class="control-group">
				<label class="span1"></label><label class="span3">Nama Dosen</label>
				<div class="controls">
					<input type="text" readonly value="<?php echo $row->nama_dos;?>" class="span10">
				</div>
			</div>			
			<div class="control-group">
