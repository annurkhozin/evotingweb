	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header blue" data-original-title>
				...
				<?php echo $nm=$this->m_campaign->cek_id($this->uri->segment(3))->row_array()['nama_campaign'];?></h2>
			</div></br>
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					...
					<tbody>
						...
						<tr>
							...
							<td class="center" >
								<center>
									<a href="<?php echo site_url('pemilih/detail/'.$this->uri->segment(3).'/'.$row->tahun);?>" title="<?php echo 'Detail Tahun '.$row->tahun.' Pada Jurusan '.$nm ;?>"
										class="btn btn-defauttooltipsku"><i class="halflings-icon search white"></i> Lihat</a>
									<a class="btn btn-md btn-info tooltipsku" href="#editthn<?php echo $row->tahun;?>" data-toggle="modal"
										title="<?php echo 'Edit Tahun '.$row->tahun.' Pada Jurusan '.$nm ;?>"><i class="halflings-icon white edit"></i> edit</a>
								</center>
							</td>
						</tr>
						<?php endforeach;?>
