...
<div class="modal hide fade " id="nonaktifkan<?php echo $row->id_user;?>">
	...
	<div class="modal-body">
		<form id="frm" name="frm" class="form-horizontal" action="<?php echo site_url(enkripsi('pemilih','nonaktifkan'));?>" method="post" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="no" readonly class="span10" value="<?php $s=$row->status; if($s=='1'){echo"Belum";}elseif($s=='0'){echo"Sudah";};?>">
				</div>
			</div>
			</br>
			</br>
