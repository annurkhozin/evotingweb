<div class="modal hide fade " id="tambah">
	...
	<div class="modal-body">
		<form action="<?php echo site_url('tatausaha/importdata')?>" method="post" enctype="multipart/form-data" role="form">
		...
		<form id="frm" name="frm" class="form-horizontal" action="<?php echo site_url('tatausaha/tambah');?>" method="post" enctype="multipart/form-data">
			<div class="control-group">
				<label class="span1"></label><label class="span3">ID Tata Usaha</label>
				<div class="controls">
					<input type="text" name="id" data-validation-required-message="Harus Diisi" placeholder="ID Tata Usaha" class="span10" required autocomplete='off'>
				</div>
			</div>
			<div class="control-group">
				<label class="span1"></label><label class="span3">Nama Tata Usaha</label>
				<div class="controls">
					<input type="text" name="nama" data-validation-required-message="Harus Diisi" placeholder="Nama Tata Usaha" class="span10" required autocomplete='off'>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="almat" placeholder="Alamat Tata Usaha" class="span10">
				</div>
			</div>
			<div class="control-group">
