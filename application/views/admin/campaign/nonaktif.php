<div id="content" class="span10">
	...
	<a href="<?php echo site_url(enkripsi('campaign','index'));?>" class="btn btn-success"><i class="halflings-icon star white"></i> Ke <?php echo $langit; ?> Aktif</a>
	</br></br>
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					  <thead>
						  <tr>
							  ...
							  <th>keterangan <?php echo $katalangit; ?></th>
							  <th><center>Kelola</center></th>
						  </tr>
					  </thead>   
					  <tbody>
						<?php $campaign = $this->db->where('status_campaign',0)->get('campaign')->result();
						 $n=0; foreach($campaign as $baris): $n++; ?>
						<tr>
							<td><?php echo $baris->id_campaign;?></td>
							<td class="center"><?php echo $baris->nama_campaign;?></td>
							<td class="center"><?php echo $baris->keterangan_campaign;?></td>
							<td class="center" >
								<center>
									<a class="btn btn-md btn-success tooltipsku" href="#aktifkan<?php echo $baris->id_campaign;?>" data-toggle="modal"
										title="<?php echo 'Aktifkan Data '.$baris->nama_campaign;?>">
...
<?php $this->load->view('admin/campaign/aktifkan.php');?>