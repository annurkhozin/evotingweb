<?php $campaign = $this->db->where('status_campaign',0)->get('campaign')->result(); $no=0; foreach($campaign as $row): $no++?>
<div class="modal hide fade " id="aktifkan<?php echo $row->id_campaign;?>">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">×</button>
		<h3>Aktifkan <?php echo $langit;?></h3>
	</div>
	<div class="modal-body">
		<form id="frm" name="frm" class="form-horizontal" action="<?php echo site_url(enkripsi('campaign','aktifkan'));?>" method="post">
